...
def main():
    ...
    for _, r in df.iterrows():
        velocity_norm = r["velocity"] / v_mean
        net_norm = r["net_now"] / n_mean
        ownership_factor = min(r["selected_by_percent"] / 50, 1)
        ...
        rows.append({
            ...
            "net_transfers": int(r["net_now"]),
            "ownership": round(r["selected_by_percent"], 2),
        })
    ...
    print(f"🔮 Predictions updated: {len(out)} players")
