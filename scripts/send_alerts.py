...
def main():
    ...
    for _, row in df.iterrows():
        name = row["web_name"]
        price = row["price"]  # ✅ correct column
        ownership = row["ownership"] if "ownership" in df.columns else row["selected_by_percent"]
        ...
        # ---- Only trigger for predicted price movement ----
