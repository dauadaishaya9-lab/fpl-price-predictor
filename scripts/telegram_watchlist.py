...
def main():
    ...
    # 🧹 Auto-clean expired reset request
    if RESET_FLAG.exists() and not reset_pending_valid():
        clear_reset_flag()
    ...
    for update in updates:
        ...
        # ---------- RESET ----------
            ...
            send_message(
                ...
                "• telegram offset\n\n"
                f"⏱️ You have *1 hour* to confirm.\n"
